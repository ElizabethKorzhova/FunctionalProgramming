...
const Lab2 = () => {
  return (
    <main className={`container ${styles.labContainer}`}>
      ...
      <ul>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#target">
            Мета лабораторної роботи
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#task-condition">
            Умова задачі
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#program-structure">
            Структура програми
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#ide">
            Обгрунтування вибору середовища та мови функціонального
            програмування
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#code">
            Код програми з коментарями
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#link-to-github">
            Посилання на проект з вихідним кодом
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#results">
            Скріншоти результатів
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#analysis">
            Аналіз достовірності результатів
          </Link>
        </li>
        <li className={styles.contentItem}>
          <Link className={styles.contentItemLink} to="lab2/#сonclusion">
            Висновки
          </Link>
        </li>
      </ul>
    ...
    (define (exponent-times acc previous current k) ; визначаємо допоміжну функцію для хвостової рекурсії. 
    acc - аккумулятор. previous - попередній елемент. current - поточний елемент. k - індекс елементу
...
`}
      ...
      <div>
        ...
        Визначити похибку.. Другим завданням було підрахувати кількість цифр у
        числі, їх суму та знайти першу і останню цифри числа. Вводимо з
        клавіатури число 67890425, вивід програми: кількість цифр - 8, сума -
        41, перша цифра в числі - 6, остання - 5. Результати співпадають з
        очікуваними
      </div>
